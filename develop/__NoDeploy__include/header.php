  ...
  <div class="header-menu">
    <div class="container d-flex flex-wrap justify-content-between align-items-start">
      <nav>
        ...
        <ul>
          <li>
          <a href="https://www.sumitomo-rd-mansion.jp/shuto/ct_noborito/list.php" target="_blank"><span class="f-en">PLAN</span><br>間取り</a>
          </li>
          <li class="has-child">
  ...
  <div class="sp-menu">
    <nav>
      <ul>
        ...
        <li>室内空間</li>
        <li><a href="https://www.sumitomo-rd-mansion.jp/shuto/ct_noborito/list.php" target="_blank">間取り</a></li>
    ...
    <div class="sp-menu-sns d-flex justify-content-center align-items-center">
      <a href="<?=$site_setting["twitter_link"] ?>" target="_blank"><img src="<?= $page_settings["directory_pos"]  ?>images/common/icn_x.png" alt="x"></a>
