  ...
  <div class="header-menu">
    <div class="container d-flex flex-wrap justify-content-between align-items-start">
      <nav>
        ...
        <ul>
          <li>
          <a href="<?= $page_settings["directory_pos"]  ?>list.php" target="_blank"><span class="f-en">PLAN</span><br>間取り</a>
          </li>
          <li class="has-child">
  ...
  <div class="sp-menu">
    <nav>
      <ul>
        ...
        <li>室内空間</li>
        <li><a href="<?= $page_settings["directory_pos"]  ?>list.php" target="_blank">間取り</a></li>
